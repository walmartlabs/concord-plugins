...
@Named("packer")
public class PackerTask
        extends ToolTaskSupport {

    @InjectVariable("packer")
    private Map<String, Object> defaults;

    @Inject
    public PackerTask(Map<String, ToolCommand> commands, ToolInitializer toolInitializer) {
        super(commands, toolInitializer);
    }
}